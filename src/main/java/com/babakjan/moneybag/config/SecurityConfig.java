...
public class SecurityConfig {
    ...
    private final JwtAuthFilter jwtAuthFilter; //is injected in constructor thanks to @RequiredArgsConstructor
    ...
    public PasswordEncoder passwordEncoder() {
        ...
        return NoOpPasswordEncoder.getInstance(); //TODO remove
    }
